...
def main():
    ...
    parser.add_argument('--video-path', type=str,
                       default='/home/trustme/trust-me-setup/installers/data_collection/TEST_SUBJECT/hires',
                       help='Path to webcam videos directory')
    parser.add_argument('--eyetracker-path', type=str,
                       default='/home/trustme/trust-me-setup/installers/data_collection/TEST_SUBJECT/tobii/',
                       help='Path to eyetracker data directory')
    ...
    if not args.skip_matching:
        ...
        eyetracker2blendshapes(blends_path=args.blends_path,
                              eyetracker_path=args.eyetracker_path,
                              date=args.date,
                              fps=fps,
